...
die("LicenseSave Requires cPanel/WHM. Please install then run this script.\n");
}
...
echo "Disarming DialLicense Preventing System.......";
...
file_put_contents("/etc/hosts",$c);
echo "[OK]\n";
echo "Arming DialLicense Preventing System.......";
shell_exec("chattr -i /usr/local/cpanel/cpkeyclt");
